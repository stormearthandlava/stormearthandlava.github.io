...
- {{ site.data.spell.fs }} deals Fire and Nature damage.

> Source: [Spell data](https://www.wowhead.com/ptr/spell=188389/flame-shock) (likely 2023-03-14)

<div class="card">
  <div class="card-header" id="fs">
    <div class="h2 mb-0">
      <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#fs-body" aria-expanded="false" aria-controls="fs-body">
        General notes
      </button>
    </div>
  </div>
  <div id="fs-body" class="collapse" aria-labelledby="fs">
    <div class="card-body" markdown="1">

This also extends the list of talent that interact with {{ site.data.spell.fs }}. New addition:
- {{ site.data.talent.natures_fury }}

Talents that should interact with it but don't (yet?):
- {{ site.data.talent.mote }}
- {{ site.data.talent.electrified_shocks }}
- {{ site.data.talent.eeq }}
