...
# Tier 30
- (2) Set Bonus: Gain {{ site.data.talent.stormkeeper }} every 50 seconds.
- (4) Set Bonus: For 8 seconds after you consume {{ site.data.talent.stormkeeper }}, your {{ site.data.spell.lb }}, {{ site.data.spell.lvb }}, {{ site.data.talent.if }}, and {{ site.data.spell.frs }} generate 75% more Maelstrom, and your {{ site.data.spell.cl }}, {{ site.data.spell.lvbm }}, and {{ site.data.spell.eq }} critical strike damage is increased by 20%.
...
*Note: The previous version of the tier set was an around 20% DPS increase with 4p, which was way too strong compared to the other specs tier sets. This change brings us more in line without "killing" the spec potential.*
...
<div class="card">
  ...
  <div id="potm-body" class="collapse" aria-labelledby="potm">
    <div class="card-body" markdown="1">
