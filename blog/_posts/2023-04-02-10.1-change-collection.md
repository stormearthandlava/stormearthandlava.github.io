...
# Tier 30
- (2) Set Bonus: Gain a single {{ site.data.talent.stormkeeper }} charge every 50 seconds (100 seconds in PvP).
- (4) Set Bonus: For 8 seconds after you consume {{ site.data.talent.stormkeeper }}, your {{ site.data.spell.lb }}, {{ site.data.spell.lvb }}, {{ site.data.talent.if }}, and {{ site.data.spell.frs }} generate 50% more Maelstrom (25% in PvP), and your {{ site.data.spell.cl }}, {{ site.data.spell.lvbm }}, and {{ site.data.spell.eq }} critical strike damage is increased by 20% (10% in PvP).
...
- When gaining {{ site.data.talent.sk }} from the tier set, the player gains 1 stacks of the {{ site.data.talent.sk }} buff, contrary to 2 stacks when the player uses the ability himself.
...
- The effect {{ site.data.spell.t30_4 }} is applied after **completly** losing the {{ site.data.talent.sk }} buff (all the charges).
...
## General tuning
- {{ site.data.talent.lvs }}s triggered by {{ site.data.talent.primordial_surge}} increase the damage of your next {{ site.data.spell.lvb}} by 15% (was 25%).
- {{ site.data.spell.lvb }} damage increased by 12%. Does not affect PvP combat.
- {{ site.data.talent.eb }} damage increased by 6%. Does not affect PvP combat.
...
- {{ site.data.spell.fs }} now interacts with the following talents:
  - {{ site.data.talent.natures_fury }}
  - {{ site.data.talent.mote }}
  - {{ site.data.talent.electrified_shocks }}
  - {{ site.data.talent.fol }}
...
* {{ site.data.spell.fs }} consumes {{ site.data.talent.mote }}, empowering its initial damage and its DoT damage for the whole duration. DoT ticks do not consume {{ site.data.talent.mote }}.
* When {{ site.data.talent.ascendance }} extends a {{ site.data.spell.fs }} buffed by {{ site.data.talent.mote }}, it preserves the buff.
* {{ site.data.spell.fs }} doesn't interact as a nature spell with {{ site.data.talent.eeq }} yet (even though it maybe should).
* {{ site.data.talent.lmt }} will now consume {{ site.data.talent.mote }} and buff one of the three {{ site.data.spell.fs }} applied.
...
> Source: [Spell data](https://www.wowhead.com/ptr/spell=188389/flame-shock) (likely 2023-03-14)
...
- {{ site.data.talent.primordial_surge }}'s damage bonus is no longer reduced in PvP combat.
