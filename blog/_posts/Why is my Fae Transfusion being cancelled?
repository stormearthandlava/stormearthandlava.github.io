...
Given the introduction of {{site.data.legendary.nf}} which grants bonus Crit % and CDR based on the number of ticks executed, this unfortunate interaction causes lost value which can feel incredibly bad.
