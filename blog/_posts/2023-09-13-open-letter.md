...
The T30 Lightning builds were added for reference. In my opinion, You get such numbers when the tier set fixes problems that are very bad and very present when it's not there. It could be a good idea to consider incorporating some of the things done by the tier into talents when the next expansion starts rolling in.
