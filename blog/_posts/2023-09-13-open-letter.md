...
The T30 Lightning builds were added for reference. In my opinion, You get such numbers when the tier set fixes problems that are very bad and very present when it's not there.
