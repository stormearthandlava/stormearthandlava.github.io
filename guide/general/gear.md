...
### Concerning Reorigination Array

Reorigination Array is a buff you will get if the following conditions are met:

1. You are zoned into Uldir.
2. You have at least one point of {{ site.data.azerite.laser_matrix }} or {{ site.data.azerite.archive_of_the_titans }}.

This buff provides you 75 extra rating to your highest secondary, stacking up to a maximum of 750 for every week you've killed 3 bosses (10 weeks). While inside of Uldir, you should look to replace any of your Azerite pieces with one of the traits needed to activate this buff.
