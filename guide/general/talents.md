        ...
        <div id="L90-collapse" class="collapse" aria-labelledby="L90" data-parent="#accordion">
            <div class="card-body">
                ...
                <ul>
                    ...
                    <li>{{ site.data.talent.lvb }} - reduces the remaining cooldown of {{ site.data.spell.fe }} / {{ site.data.talent.se }} by 6 seconds.</li>
                    <li>{{ site.data.talent.frs }} - freeze the target in place for 6 seconds. Damage doesn't break the freeze</li>
                </ul>
                <hr><br>
