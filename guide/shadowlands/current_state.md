...
10.04.2020: Todays information were gathered with the help of Rezyn#3520.
...
| Flame Shock | 40yd range<br/>Instant, 6 sec cooldown<br/>Sears the target with fire, causing (22.75% of Spell power) Fire damage and then an additional (105% of Spell power) Fire damage over 18 sec. |
...
Spell Details |
| Earth Shock | 40yd range<br/>Instant<br/>Instantly shocks the target with concussive force, causing (42% of Spell power) Nature damage.<br/><br/>Earth Shock will consume all stacks of Fulmination to deal extra Nature damage to your target. |
...
### Elemental Blast
- Overloads create their own buff
- Additional buffs can only have different stats
- Only two buffs can be active at the same time

### Echoing Shock
- Not affected by Master of the Elements
- Not affected by Elemental Fury
- Triggered cast is an independant event (can crit, can overload, can buff)
- If (full-stack) buffs are still present on doubled casts, they are not refreshed (Elemental Blast, Surge of Power, Icefury)
- Copies of a Master of the Elements empowered casts are no longer empowered by Master of the Elements
- Copied Lightning Bolt while Stormkeeper was still active was buffed without consuming a buff
- Copied Frost Shock while Icefury was still active was buffed without consuming a buff
- Flame Shock refreshes with pandemic
- Earthquake copy is cast at the same location
...
### Totem Mastery
- stacks Fulmination outfight [it's as op as it sounds]
...
### Surge of Power
- spamable because no restrictions/limitations/conditions are tied to Earth Shock anymore
- Earth Shock -> Frost Shock -> ... this circle provides a perma root against a single target
