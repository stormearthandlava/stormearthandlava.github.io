...
<div id="accordion">
<div class="card">
<div class="card-header" id="chimaerus">
<div data-toggle="collapse" data-target="#chimaerus-collapse" aria-expanded="true" aria-controls="chimaerus-collapse" class="raid-header dreamrift1"><h2 style="margin-top: 30px;">Chimaerus the Undreamt God</h2></div>
</div>
<div id="chimaerus-collapse" class="collapse" aria-labelledby="chimaerus" data-parent="#accordion">
...
#### Damage:
* Focus down {{ site.data.raid.dreamrift.colossal_horror }} while they are targetable.
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime while soaking {{ site.data.raid.dreamrift.alndust_upheaval }}.

#### Defensives:
* Use {{ site.data.spell.as }} when targeted by {{ site.data.raid.dreamrift.consuming_miasma }} or {{ site.data.raid.dreamrift.rift_madness }} [Mythic-only].
* Use {{ site.data.spell.ghost_wolf }} when targeted by {{ site.data.raid.dreamrift.rift_madness }} [Mythic-only] to maintain {{ site.data.spell.sw }} mitigation while horrified.
* Use {{ site.data.spell.healing_surge }} as needed and utilize {{ site.data.spell.hst }} as a movement filler.

#### Utilities:
* Use {{ site.data.spell.wrt }} to help players dodging {{ site.data.raid.dreamrift.corrupted_devastation }}.
* Use {{ site.data.spell.wind_shear }} to interrupt {{ site.data.raid.dreamrift.essence_bolt }} and {{ site.data.raid.dreamrift.fearsome_cry }} from {{ site.data.raid.dreamrift.haunting_essence }}.
